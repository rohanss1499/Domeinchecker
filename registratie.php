        ...
        <form>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="mainContactAddressNumber"
                           class="form-control input-md input-md--tip address-number" id="inputHouseNumber" value=""
                           placeholder="bijv. 42B" data-remember-me="yes">
                </div>
                <div class="col-xs-12 col--xs">
                    <div class="text-extra-small postal-code-message"
                         data-default-message="Deze postcode is ongeldig, controleer of alle gegevens kloppen.">
                    </div>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <div class="form-group form-group-md">
                        ...
                        <select class="form-control input-md input-md--tip country" name="mainContactCountryCode"
                                id="inputCountry" data-remember-me="yes">
                ...
                <div class="form-group col-md-6">
                    <div class="form-group form-group-md">
                        ...
                        <input type="text" name="mainContactPhone" class="form-control input-md input-md--tip"
                               id="inputPhoneNumber" value="" placeholder="bijv. 0612345678" data-remember-me="yes">
                    </div>
                </div>
            </div>
